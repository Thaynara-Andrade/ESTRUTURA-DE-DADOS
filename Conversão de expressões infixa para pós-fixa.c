...
2 3 + 5 2 + * 3 8 + 2 - 2 3 + * 3 4 + * *
que elimina a necessidade de parênteses. Se durante o processo de conversão, seu programa detectar parênteses desbalanceados ou uso de dois operadores aritméticos seguidos, ele deve parar e avisar que houve erro.
...
int main()
{
        ...
        printf("DIGITE A SUA EXPRESSÃO INFIXA: ");
        gets(infixa);
        posfix_infix();
        value=calculadora_posfixa();
        printf("EXPRESSÃO POSFIXA : %s\n",posfixa);
        printf("RESULTADO DA EXPRESSÃO : %ld\n",value);
        return 0;
